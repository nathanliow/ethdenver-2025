    ...
    <footer className="bg-gray-900 py-16 px-8">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white font-bold text-xl mb-4">Inflection</h3>
            <p className="text-gray-400">
              A decentralized platform for fundraising campaigns.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>© {new Date().getFullYear()} Inflection. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
